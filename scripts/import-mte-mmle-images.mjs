/**
 * Upsert product serial 4 — AKMC MTE - MMLE — with client-provided images.
 * Idempotent by canonical id / slug. Never creates a second product row.
 *
 * Usage:
 *   node --env-file=.env scripts/import-mte-mmle-images.mjs
 */
...
const SOURCE_FILES = [
  "c__Users_HP_AppData_Roaming_Cursor_User_workspaceStorage_accbbb077229251b7743295347048714_images_WhatsApp_Image_2026-07-31_at_2.39.09_PM__1_-7a413c6c-5e6e-41bb-9284-7a38e352c279.png",
  "c__Users_HP_AppData_Roaming_Cursor_User_workspaceStorage_accbbb077229251b7743295347048714_images_WhatsApp_Image_2026-07-31_at_2.39.09_PM__2_-235db41e-b7d7-48ee-8fd9-99863e5ba646.png",
  "c__Users_HP_AppData_Roaming_Cursor_User_workspaceStorage_accbbb077229251b7743295347048714_images_WhatsApp_Image_2026-07-31_at_2.39.09_PM__3_-40dbc87a-406f-4bb1-9810-003319372ccf.png",
  "c__Users_HP_AppData_Roaming_Cursor_User_workspaceStorage_accbbb077229251b7743295347048714_images_WhatsApp_Image_2026-07-31_at_2.39.09_PM-2a15b0a9-f855-4e00-b9b3-aeffc3588a0b.png",
];

const SLUG = "akmc-mte-mmle";
const FOLDER = SLUG;
const CANONICAL_ID = "d0000000-0000-4000-8000-000000000004";
const PRODUCT_CODE = "AKMC MTE - MMLE";
...
async function main() {
  ...
  const { data: byCode } = await supabase
    ...
    .select("id, name, slug")
    .or(
      `product_code.eq.${PRODUCT_CODE},sku.eq.${PRODUCT_CODE},name.ilike.%MTE - MMLE%,name.ilike.%MTE-MMLE%`,
    )
    .limit(5);
  ...
  if (uniqueIds.length > 1) {
    console.error("Multiple MTE-MMLE product rows found — refusing to create/update duplicates:", uniqueIds);
    process.exit(2);
  }
  ...
  console.log(
    isUpdate
      ...
      : `Creating serial-4 product ${productId} (was missing from catalog)`,
  );
  ...
  const productPayload = {
    ...
    short_description: "Silk Weaving Saree with Unstitched Blouse",
    ...
    description: "Silk Weaving Saree with Unstitched Blouse",
    mrp: 3869.2,
    selling_price: 3869.2,
    akm_care_price: 3492,
    price: 3492,
    discount_percent: 9.75,
    gst_percent: 18,
    ...
    tags: ["Silk Weaving", "Ethnic Wear", "Saree", "Apparel", "AKM Care"],
    image_url: uploaded[0].url,
    images: uploaded.map((u) => ({ src: u.url, alt: u.alt })),
    seo_title: "AKMC MTE - MMLE | Silk Weaving Saree | AKM Care",
    seo_description: "Buy AKMC MTE - MMLE silk weaving saree with unstitched blouse. AKM Care price ₹3492.",
    specifications: {
      variant: "Silk Weaving",
      packing: "Box Packing",
      blouse: "Unstitched",
      colours: 4,
      size: "6.3 Mtrs APX",
  ...
  await supabase.from("product_colors").insert([
    { product_id: productId, name: "Magenta", hex: "#C2185B", slug: "magenta", image_indexes: [0, 1], sort_order: 0 },
    { product_id: productId, name: "Deep Red", hex: "#B71C1C", slug: "deep-red", image_indexes: [2, 3], sort_order: 1 },
    { product_id: productId, name: "Colour 3", hex: "#8E2444", slug: "colour-3", image_indexes: [0], sort_order: 2 },
    { product_id: productId, name: "Colour 4", hex: "#6A1B2A", slug: "colour-4", image_indexes: [2], sort_order: 3 },
  ]);

  await supabase.from("featured_products").upsert(
    { product_id: productId, slot: "shop", display_order: 4, is_active: true },
  ...
  console.log(
    JSON.stringify(
      {
        mode: isUpdate ? "update" : "create-serial-4",
        productId,
