...
const faqs = [
  {
    ...
    answer:
      "Orders are delivered pan-India. Enter a 6-digit pincode on a product page to check whether that pincode is currently serviceable. The final delivery date is confirmed at checkout.",
  },
  {
  ...
  },
  {
    ...
    answer: `Unused products can be returned within ${SHIPPING_POLICY.returnWindowDays} days if they are in original packing. Cancellation, returns and refunds are handled by support rather than as a self-serve checkout action.`,
  },
  {
    question: "How do I start a return?",
    answer: `Email ${CONTACT_EMAIL} or call ${CONTACT_PHONE} with your order number. Include photos if the item arrived damaged.`,
  },
];
...
export default function ShippingReturns() {
  return (
    <>
      <SEO
        title="Shipping & Returns — AKM Care"
        description="Pan-India delivery windows, shipping charges, and the 7-day unused-product return policy for AKM Care orders."
        ...
        <div className="container-premium max-w-3xl space-y-10">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              {DEFAULT_SHIPPING_CONFIG.freeAbove}. These amounts are store settings and may change. Checkout totals always
              use the server-calculated amount — not a guess from this page.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Unused items may be returned within {SHIPPING_POLICY.returnWindowDays} days in original packing. This matches
              the return window shown on product pages and the shop trust strip. Returns are arranged through support, not
              as an automatic checkout button.
            </p>
          </div>
          ...
          <p className="text-sm text-muted-foreground">
            ...
            at {CONTACT_EMAIL} / {CONTACT_PHONE}.
          </p>
        </div>
      </section>
    </>
