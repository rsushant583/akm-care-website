...
export default function Privacy() {
  return (
    <>
      <SEO
        title="Privacy Policy — AKM Care"
        description="How AKM Care handles account, order and contact information on www.akmcare.in."
        canonical="/privacy"
        ...
        <div className="container-premium max-w-3xl space-y-10">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              This policy describes how AKM Care (Ahmedabad, Gujarat, India) handles information submitted through{" "}
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground leading-relaxed">
              ...
              <li>
                Technical logs needed to run the site (for example, security and error diagnostics). We do not sell
                customer lists.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              request deletion of account data, email {CONTACT_EMAIL}. Some records may be retained where the law requires
              it.
            </p>
          </div>
