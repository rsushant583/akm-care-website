        ...
        <div className="container-premium max-w-3xl space-y-10">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              without notice. An order is accepted when payment is confirmed (or cash-on-delivery is recorded) and stock
              can be fulfilled. Shipping windows and charges are described on{" "}
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              {BRAND.name}. Website descriptions are informational and do not replace a signed statement of work.
            </p>
          </div>
          ...
          <p className="text-sm text-muted-foreground">
            Contact {BRAND.email} or {BRAND.phoneDisplay}.
          </p>
        </div>
      </section>
    </>
