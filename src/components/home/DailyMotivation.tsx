    ...
    >
      <div className="container-premium py-6 sm:py-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 id="thought-of-the-day-heading" className="font-heading text-xl sm:text-2xl mb-3">
            Thought of the day
          </h2>
          <blockquote className="font-heading text-base sm:text-lg leading-relaxed text-[#1A1A1A] mb-2">
            “{quote.text}”
          </blockquote>
          <p className="type-meta text-sm mb-4">— {quote.author}</p>
