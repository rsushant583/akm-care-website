  ...
  return (
    <DailyQuoteProvider>
      ...
      >
        ...
        <main className="flex-1 flex flex-col pt-[calc(3.2rem+2.25rem+env(safe-area-inset-top,0px))] lg:pt-[calc(3.8rem+2.25rem+env(safe-area-inset-top,0px))] relative min-h-0 pb-[max(4rem,calc(4rem+env(safe-area-inset-bottom,0px)))] lg:pb-0">
          <div
