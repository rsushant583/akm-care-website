...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col pt-[calc(3.2rem+env(safe-area-inset-top,0px))] lg:pt-[calc(3.8rem+env(safe-area-inset-top,0px))] relative min-h-0 pb-[max(4rem,calc(4rem+env(safe-area-inset-bottom,0px)))] lg:pb-0">
        <div
