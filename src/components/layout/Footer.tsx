...
export default function Footer() {
  return (
    <footer className="bg-foreground text-card pt-20 pb-24 lg:pb-10">
      <div className="container-premium">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.youtube.com/@akmcare1309" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-card/10 flex items-center justify-center hover:bg-primary transition-all duration-500 ease-in-out">
                <Youtube size={16} />
              </a>
              <a href="https://wa.me/918200224226" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-card/10 flex items-center justify-center hover:bg-primary transition-all duration-500 ease-in-out">
                <MessageCircle size={16} />
              </a>
              <a href="https://www.facebook.com/share/1Jjs7ipP1x/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-card/10 flex items-center justify-center hover:bg-primary transition-all duration-500 ease-in-out" aria-label="AKM Care on Facebook">
                <Facebook size={16} />
              </a>
            </div>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-card/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-card/50">© 2025 AKM Care. All Rights Reserved.</p>
